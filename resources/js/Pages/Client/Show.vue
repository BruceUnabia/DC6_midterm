            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex justify-between">
                <div class="bg-white p-4 rounded shadow w-[30%]">
                    ...
                    <div>
                        <div class="w-80 m-auto lg:mt-2 max-w-sm">
                            <h2 class="text-center text-gray-800 text-2xl font-bold pt-6">Name:{{ client.first_name }} {{ client.last_name }}</h2>
                            ...
                            <div class="grid grid-cols-4 w-72 lg:w-6/6 m-auto mt-5 p-4 lg:p-4 rounded-2xl">
                ...
                <div class="bg-white p-4 rounded shadow w-[68%]">
                    ...
                    <table class="w-full text-sm text-left text-black">
                        <thead class="text-xs text-black uppercase text-center bg-gray-50 dark:bg-blue-500 dark:text-white-400">
                            <tr>
